...
extension AnyTransition {
    static let rollUp: AnyTransition = asymmetric(insertion: move (edge: .bottom), removal:
            .move (edge: . top))
    static let rollDown: AnyTransition = asymmetric(insertion: move(edge: .top), removal:
            .move (edge: . bottom))
}
...
struct AnimatedActionButton: View {
    ...
    init(_ title: String? = nil, systemImage: String? = nil, role: ButtonRole? = nil,
